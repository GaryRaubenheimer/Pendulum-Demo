...
def draw_rod(b):
    ...
    # draw line
    pygame.draw.line(screen, b.colour, p1_from_ORIGIN, p2_from_ORIGIN, ROD_WIDTH)
    
    # draw begin point
    pygame.draw.circle(screen, RED, p1_from_ORIGIN, ROD_WIDTH)
    ...
    # draw end point
    pygame.draw.circle(screen, RED, p2_from_ORIGIN, ROD_WIDTH)
    ...
    while running:
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if event.button == 1:
                    ...
                    p1_position = rods[0].p1_position
                    p1_from_ORIGIN = [p1_position[0] + ORIGIN_POINT[0], 
                                      p1_position[1] + ORIGIN_POINT[1]]
                    
                    upper_bound_x = p1_from_ORIGIN[0] + ROD_WIDTH
                    lower_bound_x = p1_from_ORIGIN[0] - ROD_WIDTH
                    upper_bound_y = p1_from_ORIGIN[1] + ROD_WIDTH
                    lower_bound_y = p1_from_ORIGIN[1] - ROD_WIDTH
                    ...
                    p2_position = rods[0].get_p2_position()
                    p2_from_ORIGIN = [p2_position[0] + ORIGIN_POINT[0], 
                                      p2_position[1] + ORIGIN_POINT[1]]
                    
                    upper_bound_x = p2_from_ORIGIN[0] + ROD_WIDTH
                    lower_bound_x = p2_from_ORIGIN[0] - ROD_WIDTH
                    upper_bound_y = p2_from_ORIGIN[1] + ROD_WIDTH
                    lower_bound_y = p2_from_ORIGIN[1] - ROD_WIDTH
        ...
        if is_button_held:
            ...
            if is_p1_clicked:
                ...
                rods[0].p1_position[0] = mouse_x -WIDTH/2
                rods[0].p1_position[1] = mouse_y -HEIGHT/3
